export type MachineStateEventData = GPIOStateEventData | IOCONStateEventData | TIMERStateEventData | UARTStateEventData | PWMStateEventData;
...
type PWMStateEventData = PWMStateRegChangeEventData;
...
export function pwmOffsetToRegName(offset: number) {
    switch(offset) {
        case 0x00: return "IR";
        case 0x04: return "TCR";
        case 0x08: return "TC";
